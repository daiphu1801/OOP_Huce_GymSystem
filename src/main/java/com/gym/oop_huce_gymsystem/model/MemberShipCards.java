...
public class MemberShipCards {
    ...
    public MemberShipCards(int card_id,int member_id,String name_card,Double renewal_count,LocalDate issue_date,LocalDate expiry_date,LocalDate lastcheckintime) {
    ...
    public String getName_card() {return name_card;}
    public void setName_card(String name_card) {this.name_card = name_card;}

    public Double getRenewal_count() {return renewal_count;}
    public void setRenewal_count(Double renewal_count) {this.renewal_count = renewal_count;}
    ...
    public LocalDate getLastcheckintime() {return lastcheckintime;}
    public void setLastcheckintime(LocalDate lastcheckintime) {this.lastcheckintime = lastcheckintime;}
